...
<head>
    ...
    <title>Ordercuy Admin - Tambah Menu</title>
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="table-responsive d-inline-block">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <form method="post" action="<?= base_url('addMenu'); ?>" enctype="multipart/form-data">
                                            <tr>
                                                <td>
                                                    <input type="file" id="menu_image" name="menu_image" accept="image/*" required>
                                                </td>
                                                <td><input type="text" class="form-control" id="menu_name" name="menu_name" required></td>
                                                <td><input type="number" class="form-control" id="menu_price" name="menu_price" required></td>
                                                <td><input type="number" class="form-control" id="menu_stock" name="menu_stock" required></td>
                                                <td>
