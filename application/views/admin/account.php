...
<head>
    ...
    <title>Ordercuy Admin - Manajemen Akun</title>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('adminEdit') ?>" class="btn btn-success btn-circle">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($user['is_active'] == 1) : ?>
                                                        <a href="<?= base_url('adminDeactivateAcc/') . $user['user_id']; ?>" class="btn btn-warning btn-circle">
                                                            <i class="fas fa-ban"></i>
                                                        </a>
                                                    <?php else : ?>
                                                        <a href="<?= base_url('adminActivateAcc/') . $user['user_id']; ?>" class="btn btn-success btn-circle">
                                                            <i class="fas fa-power-off"></i>
                                                        </a>
                                                    <?php endif; ?>
                                                    <a href="<?= base_url('adminDeleteAcc/') . $user['user_id']; ?>" class="btn btn-danger btn-circle" onclick="return confirm('Anda yakin ingin menghapus akun ini ?')">
                                                        <i class="fas fa-trash"></i>
                                                    </a>
                                                </td>
                                            </tr>
