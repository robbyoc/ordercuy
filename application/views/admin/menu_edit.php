...
<head>
    ...
    <title>Ordercuy Admin - Edit Menu</title>
                        ...
                        <div class="card-body text-center">
                            <div class="table-responsive d-inline-block">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <form method="post" action="<?= base_url('editMenu/') . $menu_item['menu_id']; ?>" enctype="multipart/form-data">
                                            <tr>
                                                <td>
                                                    <?php if (!empty($menu_item['menu_image'])) : ?>
                                                        <img src="<?= base_url('assets/img/makanan/') . $menu_item['menu_image']; ?>" alt="Menu Image" class="img-thumbnail" style="max-width: 150px;">
                                                    <?php endif; ?>
                                                    <br>
                                                    <br>
                                                    <input type="file" id="menu_image" name="menu_image" accept="image/*">
                                                </td>
                                                <td><input type="text" class="form-control" id="menu_name" name="menu_name" value="<?= $menu_item['menu_name']; ?>" required></td>
                                                <td><input type="number" class="form-control" id="menu_price" name="menu_price" value="<?= $menu_item['menu_price']; ?>" required></td>
                                                <td><input type="number" class="form-control" id="menu_stock" name="menu_stock" value="<?= $menu_item['menu_stock']; ?>" required></td>
                                                <td>
