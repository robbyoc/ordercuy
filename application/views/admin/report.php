...
<head>
    ...
    <title>Ordercuy Admin - Laporan Keuangan</title>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Nama Menu</th>
                                            <th>Jumlah Menu Terjual</th>
                                            <th>Harga Satuan Menu</th>
                                            <th>Total Harga</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?= ucfirst(str_replace('_', ' ', $item['menu_name'])); ?></td>
                                                <td><?= ($item['total_quantity'] != null) ? $item['total_quantity'] : '0'; ?></td>
                                                <td>Rp <?= number_format($item['menu_price'], 0, ',', '.'); ?></td>
                                                <td>Rp <?= number_format($item['total_subtotal'], 0, ',', '.'); ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                        <tr>
                                            <td colspan="3" class="text-center"><strong>Total Pendapatan</strong></td>
                                            <td>Rp <?= number_format($report_earning, 0, ',', '.'); ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
