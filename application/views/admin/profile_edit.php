...
<head>
    ...
    <title>Ordercuy Admin - Edit Profil</title>
                    ...
                    <div class="card shadow mb-4 w-100">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="table-responsive d-inline-block">
                                <form method="post" action="<?= base_url('adminUpdate') ?>">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <input type="text" name="user_fullname" class="form-control" value="<?= isset($user['user_fullname']) ? $user['user_fullname'] : '' ?>">
                                                </td>
                                                <td>
                                                    <input type="email" name="user_email" class="form-control" value="<?= isset($user['user_email']) ? $user['user_email'] : '' ?>">
                                                </td>
                                                <td>
